...
class Page__Sefaresh_Pooshak_mardane extends StatefulWidget {
  @override
  _Page__Sefaresh_Pooshak_mardaneState createState() =>
      _Page__Sefaresh_Pooshak_mardaneState();
}

class _Page__Sefaresh_Pooshak_mardaneState
    extends State<Page__Sefaresh_Pooshak_mardane> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url = Uri.http(
        globals.django_url, globals.sefaresh_pooshak_mardane_getall_url);
