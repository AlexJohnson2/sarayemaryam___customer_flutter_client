...
class Page__Hejab_Shal extends StatefulWidget {
  @override
  _Page__Hejab_ShalState createState() => _Page__Hejab_ShalState();
}

class _Page__Hejab_ShalState extends State<Page__Hejab_Shal> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.hejab_shal_getall_url);
