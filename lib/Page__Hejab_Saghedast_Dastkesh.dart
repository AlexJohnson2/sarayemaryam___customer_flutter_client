...
class Page__Hejab_Saghedast_Dastkesh extends StatefulWidget {
  @override
  _Page__Hejab_Saghedast_DastkeshState createState() =>
      _Page__Hejab_Saghedast_DastkeshState();
}

class _Page__Hejab_Saghedast_DastkeshState
    extends State<Page__Hejab_Saghedast_Dastkesh> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url = Uri.http(
        globals.django_url, globals.hejab_saghedast_dastkesh_getall_url);
