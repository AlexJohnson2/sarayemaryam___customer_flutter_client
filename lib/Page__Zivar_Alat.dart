...
class Page__Zivar_Alat extends StatefulWidget {
  @override
  _Page__Zivar_AlatState createState() => _Page__Zivar_AlatState();
}

class _Page__Zivar_AlatState extends State<Page__Zivar_Alat> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.zivar_alat_getall_url);
