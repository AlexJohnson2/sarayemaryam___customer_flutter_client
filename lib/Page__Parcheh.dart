...
class Page__Parcheh extends StatefulWidget {
  @override
  _Page__ParchehState createState() => _Page__ParchehState();
}

class _Page__ParchehState extends State<Page__Parcheh> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.parcheh_getall_url);
