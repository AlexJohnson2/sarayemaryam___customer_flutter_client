...
class Page__Pooshak_mardane extends StatefulWidget {
  @override
  _Page__Pooshak_mardaneState createState() => _Page__Pooshak_mardaneState();
}

class _Page__Pooshak_mardaneState extends State<Page__Pooshak_mardane> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.pooshak_mardane_getall_url);
