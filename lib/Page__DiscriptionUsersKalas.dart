...
class _Page__DiscriptionUsersKalasState
  ...
  Row generateItem(context, index, selectedradio) {
    ...
    return Row(children: [
      Text(text),
      Radio(
          value: colors_values.reversed.toList()[index],
          groupValue: selected,
          onChanged: (value) {
            setState(() {
              // print(value);
              // print(selected);
              selected = colors_values.reversed.toList()[index];
              // print(selected);
              sizes = [];
              for (var i in product.color_size["result"]) {
                // print(i);
  ...
  Row generateItemSize(context, index, selectedradio) {
    ...
    return Row(children: [
      Text(text),
      Radio(
          value: sizes.reversed.toList()[index],
          groupValue: selectedSize,
          onChanged: (value) {
            setState(() {
              // print(value);
              print(selectedSize);
              selectedSize = sizes.reversed.toList()[index];
              print(selectedSize);
              for (var i in product.color_size["result"]) {
                if (i["color"] == selected) {
                  for (var j in i["size"]) {
