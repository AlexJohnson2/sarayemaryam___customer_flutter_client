...
class Page__Pooshak_nozadi extends StatefulWidget {
  @override
  _Page__Pooshak_nozadiState createState() => _Page__Pooshak_nozadiState();
}

class _Page__Pooshak_nozadiState extends State<Page__Pooshak_nozadi> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.pooshak_nozadi_getall_url);
