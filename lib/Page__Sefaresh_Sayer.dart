...
class Page__Sefaresh_sayer extends StatefulWidget {
  @override
  _Page__Sefaresh_sayerState createState() => _Page__Sefaresh_sayerState();
}

class _Page__Sefaresh_sayerState extends State<Page__Sefaresh_sayer> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url =
        Uri.http(globals.django_url, globals.sefaresh_pooshak_sayer_getall_url);
