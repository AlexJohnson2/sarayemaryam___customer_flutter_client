...
class Page__Kharazi_Lavazem_Tahrir extends StatefulWidget {
  @override
  _Page__Kharazi_Lavazem_TahrirState createState() =>
      _Page__Kharazi_Lavazem_TahrirState();
}

class _Page__Kharazi_Lavazem_TahrirState
    extends State<Page__Kharazi_Lavazem_Tahrir> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url =
        Uri.http(globals.django_url, globals.kharazi_lavazemtahrir_getall_url);
