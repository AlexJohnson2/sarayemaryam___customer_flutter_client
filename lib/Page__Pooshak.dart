...
class Page__Pooshak extends StatefulWidget {
  @override
  _Page__PooshakState createState() => _Page__PooshakState();
}

class _Page__PooshakState extends State<Page__Pooshak> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.pooshak_getall_url);
