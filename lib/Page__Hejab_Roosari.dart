...
class Page__Hejab_Roosari extends StatefulWidget {
  @override
  _Page__Hejab_RoosariState createState() => _Page__Hejab_RoosariState();
}

class _Page__Hejab_RoosariState extends State<Page__Hejab_Roosari> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.hejab_roosari_getall_url);
