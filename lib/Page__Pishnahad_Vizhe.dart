...
class Page__Pishnahad_Vizhe extends StatefulWidget {
  @override
  _Page__Pishnahad_VizheState createState() => _Page__Pishnahad_VizheState();
}

class _Page__Pishnahad_VizheState extends State<Page__Pishnahad_Vizhe> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.pishnahad_vizhe_getall_url);
