...
class Page__Hejab_Mask_Pooshie extends StatefulWidget {
  @override
  _Page__Hejab_Mask_PooshieState createState() =>
      _Page__Hejab_Mask_PooshieState();
}

class _Page__Hejab_Mask_PooshieState extends State<Page__Hejab_Mask_Pooshie> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url =
        Uri.http(globals.django_url, globals.hejab_mask_pooshie_getall_url);
