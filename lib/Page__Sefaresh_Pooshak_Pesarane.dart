...
class Page__Sefaresh_Pooshak_pesarane extends StatefulWidget {
  @override
  _Page__Sefaresh_Pooshak_pesaraneState createState() =>
      _Page__Sefaresh_Pooshak_pesaraneState();
}

class _Page__Sefaresh_Pooshak_pesaraneState
    extends State<Page__Sefaresh_Pooshak_pesarane> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url = Uri.http(
        globals.django_url, globals.sefaresh_pooshak_pesarane_getall_url);
