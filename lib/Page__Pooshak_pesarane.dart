...
class Page__Pooshak_pesarane extends StatefulWidget {
  @override
  _Page__Pooshak_pesaraneState createState() => _Page__Pooshak_pesaraneState();
}

class _Page__Pooshak_pesaraneState extends State<Page__Pooshak_pesarane> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.pooshak_pesarane_getall_url);
