...
class Page__Hejab extends StatefulWidget {
  @override
  _Page__HejabState createState() => _Page__HejabState();
}

class _Page__HejabState extends State<Page__Hejab> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.hejab_getall_url);
