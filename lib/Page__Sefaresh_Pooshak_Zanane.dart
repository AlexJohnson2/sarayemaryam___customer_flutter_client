...
class Page__Sefaresh_Pooshak_zanane extends StatefulWidget {
  @override
  _Page__Sefaresh_Pooshak_zananeState createState() =>
      _Page__Sefaresh_Pooshak_zananeState();
}

class _Page__Sefaresh_Pooshak_zananeState
    extends State<Page__Sefaresh_Pooshak_zanane> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url = Uri.http(
        globals.django_url, globals.sefaresh_pooshak_zanane_getall_url);
