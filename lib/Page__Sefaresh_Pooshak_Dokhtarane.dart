...
import 'Page__DiscriptionSefaresh.dart';

class Page__Sefaresh_Pooshak_dokhtarane extends StatefulWidget {
  @override
  _Page__Sefaresh_Pooshak_dokhtaraneState createState() =>
      _Page__Sefaresh_Pooshak_dokhtaraneState();
}

class _Page__Sefaresh_Pooshak_dokhtaraneState
    extends State<Page__Sefaresh_Pooshak_dokhtarane> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url = Uri.http(
        globals.django_url, globals.sefaresh_pooshak_dokhtarane_getall_url);
      ...
      child: InkWell(
        onTap: () {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) =>
                  Page__DiscriptionSefaresh(product, Colors_values)));
        },
        child: Center(
          child: Padding(
