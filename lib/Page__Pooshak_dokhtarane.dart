...
class Page__Pooshak_dokhtarane extends StatefulWidget {
  @override
  _Page__Pooshak_dokhtaraneState createState() =>
      _Page__Pooshak_dokhtaraneState();
}

class _Page__Pooshak_dokhtaraneState extends State<Page__Pooshak_dokhtarane> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url =
        Uri.http(globals.django_url, globals.pooshak_dokhtarane_getall_url);
