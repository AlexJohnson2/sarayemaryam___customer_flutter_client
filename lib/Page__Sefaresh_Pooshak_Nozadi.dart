...
class Page__Sefaresh_Pooshak_nozadi extends StatefulWidget {
  @override
  _Page__Sefaresh_Pooshak_nozadiState createState() =>
      _Page__Sefaresh_Pooshak_nozadiState();
}

class _Page__Sefaresh_Pooshak_nozadiState
    extends State<Page__Sefaresh_Pooshak_nozadi> {
  List<Product> _items = [];
  ...
  void getItems() async {
    ...
    globals.items = [];
    var url = Uri.http(
        globals.django_url, globals.sefaresh_pooshak_nozadi_getall_url);
