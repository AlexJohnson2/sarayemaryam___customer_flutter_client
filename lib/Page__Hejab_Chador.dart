...
class Page__Hejab_Chador extends StatefulWidget {
  @override
  _Page__Hejab_ChadorState createState() => _Page__Hejab_ChadorState();
}

class _Page__Hejab_ChadorState extends State<Page__Hejab_Chador> {
  List<Product> _items = [];

  void getItems() async {
    _items = [];
    globals.items = [];
    var url = Uri.http(globals.django_url, globals.hejab_chador_getall_url);
